          ...
          <div class="col-md-8 offset-md-2">
            <ul class="list-group">
              ...
              <p class="m-0 p-5" style="text-align: left">兩種獎項可同時參加，各以投稿一篇為限，上傳作品檔案前，請謹慎確認。也請注意上傳的檔案格式：
                ...
                同意書下載： <a href="/console/assets/file/source/agreement530.docx" download="同意書">word檔</a>、<a href="/console/assets/file/source/agreement530.pdf" download="同意書">pdf檔</a>)</p>
              <div class="row">
