  ...
  <div id="app">
   <div class="py-5 w-100">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <img class="img-fluid d-block mx-auto" src="dist/panscifi_logo.png" width="333px" height="100px"> </div>
      </div>
    </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 offset-md-2 text-center">
            <img class="img-fluid d-block rounded-circle mx-auto" src="icon_1_active.png" width="100px" height="100px">
            <div class="col-md-12 p-5">
              <a href="myfile.html" class="btn btn-lg m-0 btn-outline-light">STEP 1：個人資料填寫 </a>
            </div>
          </div>
          <div class="col-md-4">
            <img class="img-fluid d-block rounded-circle mx-auto" src="icon_2_active.png" width="100px" height="100px">
            ...
            <div class="card-body">
              <form action="https://formspree.io/YOUREMAILHERE">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="* 帳號 或 E-mail"> </div>
                <div class="form-group">
